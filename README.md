...
###### **Recovering**
Program checks whether a target shape exists from the chosen 'finalstego.png' file, by printing out the conjugation map, from the bits located inside the complex planes. Bits are reassembled and recovered back into the original image payload.
